...
export default function GameOverPage() {
  ...
  const { winner, finalLeaderboard, gameState, leaveGame } = useSocket()
  ...
  useEffect(() => {
    // If not in 'over' state and no leaderboard, redirect
  ...
  return (
    <div className="min-h-screen bg-arena-bg text-arena-text antialiased grid-bg">
      ...
      <section className="py-12 text-center relative">
        ...
        {winner && (
          <div className="inline-flex flex-col items-center">
            ...
            <div className="relative bg-arena-panel border rounded-2xl p-8 max-w-xs"
              ...
              <div className="w-20 h-20 rounded-full border-4 mx-auto mb-4 flex items-center justify-center font-mono text-3xl font-bold"
                   style={{ borderColor: '#ffd700', boxShadow: '0 0 16px rgba(255,215,0,0.5)', backgroundColor: '#161b22', color: '#ffd700' }}>
                {winner.username.charAt(0).toUpperCase()}
              </div>
              <h2 className="font-mono text-2xl font-extrabold text-white">{winner.username}</h2>
              ...
              <div className="flex items-center justify-center gap-2">
                <span className="font-mono text-4xl font-extrabold text-arena-green">{winner.totalScore}</span>
      ...
      {/* MAIN CONTENT */}
      <main className="max-w-4xl mx-auto px-6 pb-12 space-y-8">
        {/* FINAL RANKINGS */}
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="btn-primary flex-1 text-black font-mono font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 text-sm cursor-pointer"
            style={{
